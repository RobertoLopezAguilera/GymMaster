...
import com.robertolopezaguilera.gimnasio.viewmodel.UsuarioViewModel
        ...
        Column(
            ...
            Card(
                ...
                Row(
                    ...
                    Text(
                        text = "${
                            mesActual.month.getDisplayName(
                                TextStyle.FULL,
                                Locale.getDefault()
                            )
                        } ${mesActual.year}",
            ...
            LazyVerticalGrid(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .weight(1f) // Asegura que el grid ocupe el espacio restante
            ) {
